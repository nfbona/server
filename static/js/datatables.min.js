 ...
 *   https://datatables.net/download/#bs5/dt-2.0.8/af-2.7.0/b-3.0.2/b-colvis-3.0.2/b-html5-3.0.2/cr-2.0.3/date-1.5.2/fc-5.0.1/fh-4.0.1/kt-2.12.1/r-3.0.2/rg-1.5.0/rr-1.5.0/sc-2.4.3/sp-2.3.1/sl-2.0.3
 *
 * Included libraries:
 *   DataTables 2.0.8, AutoFill 2.7.0, Buttons 3.0.2, Column visibility 3.0.2, HTML5 export 3.0.2, ColReorder 2.0.3, DateTime 1.5.2, FixedColumns 5.0.1, FixedHeader 4.0.1, KeyTable 2.12.1, Responsive 3.0.2, RowGroup 1.5.0, RowReorder 1.5.0, Scroller 2.4.3, SearchPanes 2.3.1, Select 2.0.3
 */
